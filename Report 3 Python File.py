...
cnx = mysql.connector.connect(host="localhost", user="root", password="1yIVWiPX43FC", database="wells_fargo_database") # - Connects to the database (Ch. 5 Slide 9 | Sample Python 1)
...
while user_choice != 4: 
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n" 
          ...
          "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
          "1) Question 1 - {Query selection and program}\n"
          "2) Question 2 - {Stored routine implementation}\n"
          "3) Question 3 - {Company task implementations}\n"
          "4) Option   4 - {Exit Program}\n"
          "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    user_choice = int(input("USER:"))
    
# - Question 1 - {Query selection and program}
    if user_choice == 1:           
        while user_choice_internal != 17:
            ...
            if user_choice_internal == 11:
                ...
                query_11 = ("SELECT a.account_number, a.account_balance, a.branch_id, b.routing_number "
                            ...
                            "WHERE a.branch_id = b.branch_id AND a.account_balance > %s AND a.account_balance < %s;") # - Stores the SQL query | Query Print formatting: TB Page 194
                ...
                for (account_number, account_balance, branch_id, routing_number) in rows:
                    print(f"\t{account_number}\t|\t{account_balance}\t|\t{branch_id}\t|{routing_number}")# - Python Sample 3
 ...
 # - Question 2: Stored Routine Implementation
    ...
    # - Question 3: Company task Implementation
    if user_choice == 3:
...
if user_choice == 4:
    ...
    cur.close(); 
    cnx.close() # - Closes connection with database (Ch. 5 Slide 9 | Sample Python 1)
